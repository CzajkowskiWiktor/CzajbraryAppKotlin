...
import com.example.czajbraryapp.Activities.Activity.CartListActivity
import com.example.czajbraryapp.Activities.Activity.SettingsActivity
import com.example.czajbraryapp.Activities.Adapters.DashboardBooksListAdapter
...
class DashboardFragment : BaseFragment() {
  ...
  fun successDashboardItemsList(dashboardItemsList: ArrayList<Book>) {
    ...
    if (dashboardItemsList.size > 0) {
      ...
      val adapter = DashboardBooksListAdapter(requireActivity(), dashboardItemsList)
